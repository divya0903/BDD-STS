...
<body>
	...
	<div class="header-container">
       ...
       <a style="color: blue;" href="Login.jsp""${pageContext.request.contextPath}/login"><b>Login</b></a>  &nbsp;|&nbsp;
           <a style="color: blue;" href="Logout.jsp""${pageContext.request.contextPath}/logout"><b>Logout</b></a>
